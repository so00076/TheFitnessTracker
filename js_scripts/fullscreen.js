...
function fullscreen() {
	...
	if(full == true) {
		...
		$('.collapse').fadeOut(0);
		document.getElementById('fullscreenbutton').innerHTML = 'X';
		full = true;
	}
}

function drawGraphPoint(currentY, x, y, fillStyle, canvas) {
	/*
	canvas.arc(x, currentY, 3, 0, 2 * Math.PI, false);
	...
	*/
	...
	//if (currentY < y) {
	//	requestAnimationFrame(drawGraphPoint(currentY, x, y, fillStyle, canvas));
	//}
